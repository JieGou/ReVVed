...
namespace RVVD
{
  ...
  public partial class ReVVed : IExternalApplication
  {
    ...
    /// 可停靠窗体
    /// </summary>
    private global::Project_Commander.Docking_Pane m_MyDockableWindow = null;
    ...
    private void CreateRibbonPanel(UIControlledApplication application)
    {
      ...
      PushButtonData dpShow_Button = new PushButtonData("dpShowButton",
                                                        LocalizationProvider.GetLocalizedValue<string>("EA_RButt_ShowDock"),
                                                        DLLPath,
                                                        "RVVD.ShowDockableWindow");
      ...
      //Displays the Project Commander Dockable Palette
      dpShow_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("EA_RButt_ShowDock_Tooltip");
      ...
      PushButtonData dpHide_Button = new PushButtonData("dpHideButton",
                                                        LocalizationProvider.GetLocalizedValue<string>("EA_RButt_HideDock"),
                                                        DLLPath,
                                                        "RVVD.HideDockableWindow");
      ...
      //Hides the Project Commander Dockable Palette
      dpHide_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("EA_RButt_HideDock_Tooltip");
      ...
      PushButton pc_Button = revvedPanel.AddItem(new PushButtonData("pcButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("PC_Title").Replace(" ", "\n"),
                                                                    DLLPath,
                                                                    "RVVD.project_commander")) as PushButton;
      ...
      //A small app for storing notes and details about the currently active project. These are not saved inside the project file.
      pc_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("PC_Tooltip");
      ...
      //An improved interface for sorting and searching through components loaded into the project.
      coco2_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("CoCo_Tooltip");
      ...
      PushButton of_Button = revvedPanel.AddItem(new PushButtonData("ofButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("OF_Title"),
                                                                    DLLPath,
                                                                    "RVVD.open_folder")) as PushButton;
      ...
      //Opens the folder that the active project or selected family is saved in.
      of_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("OF_Tooltip");
      ...
      PushButton mt_Button = revvedPanel.AddItem(new PushButtonData("mtButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("MT_Title"),
                                                                    DLLPath,
                                                                    "RVVD.merge_text")) as PushButton;
      ...
      //Merges multiple text notes into a single note.
      mt_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("MT_Tooltip");
      ...
      PushButton pl_Button = revvedPanel.AddItem(new PushButtonData("plButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("P_Title"),
                                                                    DLLPath,
                                                                    "RVVD.poly_line")) as PushButton;
      ...
      //Sets the total length of multiple joined lines.
      pl_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("P_Tooltip");
      ...
      PushButton wl_Button = revvedPanel.AddItem(new PushButtonData("wlButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("WL_Title"),
                                                                    DLLPath,
                                                                    "RVVD.web_link")) as PushButton;
      ...
      //Gets the URL of a component and opens the webpage in a minibrowser.
      wl_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("WL_Tooltip");
      ...
      PushButton cc_Button = revvedPanel.AddItem(new PushButtonData("ccButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("CC_CommandName"),
                                                                    DLLPath,
                                                                    "RVVD.change_case")) as PushButton;
      ...
      //Changes the case of selected items.
      cc_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("CC_Tooltip");
      ...
      PushButton uc_Button = revvedPanel.AddItem(new PushButtonData("ucButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("UC_Title"),
                                                                    DLLPath,
                                                                    "RVVD.upper_case")) as PushButton;
      ...
      // Changes the case of selected items to upper case.
      uc_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("UC_Tooltip");
      uc_Button.Visible = Properties.Settings.Default.UpperCase;
      //upper case and change case can use same
      uc_Button.AvailabilityClassName = "RVVD.cc_AvailableCheck";
      uc_Button.SetContextualHelp(Chelp.cc_help); //same as change case

      //Create a Button for grid flip
      PushButton gf_Button = revvedPanel.AddItem(new PushButtonData("gfButton",
                                                                    LocalizationProvider.GetLocalizedValue<string>("GF_Title"),
                                                                    DLLPath,
                                                                    "RVVD.grid_flip")) as PushButton;
      ...
      //Flips the start and end points of grid lines.
      gf_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("GF_Tooltip");
      ...
      PushButton rev_Button = revvedPanel.AddItem(new PushButtonData("revButton",
                                                                     LocalizationProvider.GetLocalizedValue<string>("R_Title"),
                                                                     DLLPath,
                                                                     "RVVD.revisionist")) as PushButton;
      ...
      //Adds revisions to multiple sheets.
      rev_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("R_Title");
      ...
      PushButtonData hlp_Button = new PushButtonData("hlpButton",
      ...
      //Help for the ReVVed suite of tools.
      hlp_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("HLP_Tooltip");
      hlp_Button.AvailabilityClassName = "RVVD.all_AvailableCheck";
      hlp_Button.SetContextualHelp(Chelp.help_help);

      PushButtonData about_Button = new PushButtonData("aboutButton",
      ...
      //Product information about the ReVVed suite of tools.
      about_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("About_Tooltip");
      about_Button.AvailabilityClassName = "RVVD.all_AvailableCheck";

      PushButtonData opt_Button = new PushButtonData("optButton",
                                                     LocalizationProvider.GetLocalizedValue<string>("OPT_Title"),
                                                     DLLPath,
                                                     "RVVD.options");
      ...
      //Configuration options for the ReVVed suite of tools.
      opt_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("OPT_Tooltip");
      ...
      //Allows you to delete obsolete projects from the Project Commander database.
      pm_Button.ToolTip = LocalizationProvider.GetLocalizedValue<string>("PC_PMW_Tooltip");
      pm_Button.AvailabilityClassName = "RVVD.all_AvailableCheck";
      //same as project commander
      pm_Button.SetContextualHelp(Chelp.pc_help);
    ...
    internal void LogEvent(string evnt)
    {
      ...
      string logfile = Path.Combine(logpath, "ReVVed.log");
      ...
      catch (IOException err)
      {
        ...
        //Logging Error
        TaskDialog td = new TaskDialog(LocalizationProvider.GetLocalizedValue<string>("EA_DIA002_Title"));
        //ReVVed could not access the log file: {0}. It is probably locked by another process.
        td.MainInstruction = string.Format(LocalizationProvider.GetLocalizedValue<string>("EA_DIA002_MainInstr"), logfile);
        //Would you like to turn off logging or just ignore this error and continue.
        td.MainContent = LocalizationProvider.GetLocalizedValue<string>("EA_DIA002_MainCont");
        //Turn off logging.
        td.AddCommandLink(TaskDialogCommandLinkId.CommandLink1, LocalizationProvider.GetLocalizedValue<string>("EA_DIA002_Comm1"));
        //Ignore and continue.
        td.AddCommandLink(TaskDialogCommandLinkId.CommandLink2, LocalizationProvider.GetLocalizedValue<string>("EA_DIA002_Comm2"));
    ...
    internal void RegisterLoggerEventHandlers(UIControlledApplication application)
    {
      //LogLevel = 2
    ...
    internal void DeregisterLoggerEventHandlers(UIControlledApplication application)
    {
    ...
    public void App_Doc_Printed(object sender, DocumentPrintedEventArgs args)
    {
      ...
      foreach (ElementId e in args.GetPrintedViewElementIds())
      {
    ...
    public void ProjectCommander_Doc_Opened(object sender, DocumentOpenedEventArgs args)
    {
      ...
      if (Properties.Settings.Default.PC_runatstart)  // if user wants to check at startup
      {
        ...
        if (!actdoc.IsFamilyDocument) // if it is not a family document
        {
          ...
          if (File.Exists(XMLfilepath)) // if XML database exists. Not first run.
          {
    ...
    private void DockablePane_ViewActivated(object sender, ViewActivatedEventArgs e)
    {
      try
      {
    ...
    #endregion Project Commander Event Handlers
  }
}