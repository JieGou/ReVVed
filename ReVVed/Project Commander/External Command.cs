    ...
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
      ...
      try
      {
        ...
        if (!File.Exists(XMLfilepath))
        {
          ...
          if (!Directory.Exists(Constants.RevvedBasePath))
          {
            Directory.CreateDirectory(Constants.RevvedBasePath);
          }
      ...
      catch (Exception err)
      {
        ...
        {
          MainInstruction = LocalizationProvider.GetLocalizedValue<string>("MT_Title") + LocalizationProvider.GetLocalizedValue<string>("ErrorDialog_MainInst"),
          MainContent = LocalizationProvider.GetLocalizedValue<string>("ErrorDialog_MainCont"),
          ExpandedContent = err.ToString(),
